...
// const StyledFinalFooter = styled(Box)(({ theme }) => ({
//   paddingTop: theme.spacing(5),
//   paddingBottom: theme.spacing(5),
//   paddingLeft: theme.spacing(10),
//   paddingRight: theme.spacing(10),
    ...
    <BannerBG>
      <StyledMainCtn>
        <StyledAboutBox>
          ...
          />
          <Box>
            RNS Institute of Technology (RNSIT) established in the year 2001, is
            the brainchild of the Group Chairman, Dr. R. N. Shetty.
          </Box>
      ...
      {/* <StyledFinalFooter>
        <StyledContentBox>
          <EmailIcon sx={{ fontSize: FONTSIZE_MEDIUM }} />
          <StyledTextBox>principal@rnsit.ac.in</StyledTextBox>
        </StyledContentBox>
      </StyledFinalFooter> */}
    </BannerBG>
  );
